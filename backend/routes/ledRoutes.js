...
import { getAllLEDData, saveLEDTab, deleteLEDTab, saveDraft, exportCombinedLED, getLEDBySubtab } from '../controllers/ledController.js';
...
// GET /api/led/:user_id/:subtab - ambil data LED untuk subtab tertentu (untuk validasi export)
router.get('/:user_id/:subtab', getLEDBySubtab);
